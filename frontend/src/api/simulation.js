 ...
 * @param {number} sentimentBias
 */
export const updateAgentSentimentBias = (simulationId, agentId, sentimentBias) => {
  return service.post(
    `/api/simulation/${simulationId}/config/agent/${agentId}/sentiment-bias`,
